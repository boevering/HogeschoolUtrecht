...
if (knop):
    ...
    if knop.isdigit():
        ...
        print 'Laatste update: '+ time +', Aantal processen:'+ process+', Percentage Gebeugengebruik:'+ mem+', Percentage Schijfgebruik:'+ hdd+', Percentage CPU-belasting'+ cpu+', Laatste Gebruiker:'+user+''
